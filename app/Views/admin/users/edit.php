            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                <form action="/admin/users/<?= $user['id'];?>/update" method="post" enctype="multipart/form-data" class="edit-user">
                                    <div class="form-group">
                                        <label for="exampleInputName">Имя</label>
                                        <input type="text" class="form-control" name="username" id="exampleInputName" value="<?= $user['username'];?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputEmail">Email</label>
                                        <input type="email" class="form-control" name="email" id="exampleInputEmail" value="<?= $user['email'];?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="checkbox">
                                            <label>
                                                <input name="status" type="checkbox" <?php if($user['status'] == 2):?> checked <?php endif;?>>
                                                Бан
                                            </label>
                                        </div>
                                    </div>
